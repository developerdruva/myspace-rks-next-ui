...
import Experience from "../../profile-page/Experience";
import {
  experience,
  getPocProjects,
  pocProjects,
} from "../extras/ResumeComponents";
...
const ResumeTemplateSample = () => {
  ...
  const handleReactPrint = useReactToPrint({
    ...
    documentTitle:
      personDetails?.first_name + personDetails?.last_name + "-Resume",
  ...
  return (
    <div>
      <Container className="">
        <Button size="sm" onClick={() => handleReactPrint()}>
          Click Print
        </Button>
            ...
            <tr>
              ...
              >
                <div style={{ border: "", backgroundColor: "", padding: "" }}>
                  <div className="blckDiv1" style={{ border: "" }}></div>
                  <div className="blckDiv1" style={{ border: "" }}></div>
                  <div className="blckDiv1" style={{ border: "" }}></div>
                  <div className="blckDiv1" style={{ border: "" }}></div>
                  <div
                  ...
                  <div className="m-0 mt-2">
                    <div
                      style={{
                        textAlign: "left",
                        fontSize: fieldProps?.fsSubTitles,
                        margin: "2px",
                        padding: "0",
                      }}
                    >
                  ...
                  <div className="d-flex justify-content-start m-0 mt-2 mb-2 p-0 text-dark  ">
                    <span className="btn m-0 p-0 me-5">
                      <a
                        size={16}
                        href={personDetails?.myblog_url}
                        target="_blank"
                        className="text-dark"
                      >
                        <BsPersonCircle />{" "}
                    ...
                    {personDetails?.linkedin_url && (
                      <span className="btn m-0 p-0 me-5">
                        <a
                          size={16}
                          href={personDetails?.linkedin_url}
                          className="text-dark"
                        >
                          <BsLinkedin />{" "}
                        </a>
                    ...
                    {personDetails?.git_url && (
                      <span className="btn m-0 p-0 me-5">
                        <a
                          size={16}
                          href={personDetails?.git_url}
                          className="text-dark"
                        >
                          <BsGithub />{" "}
                        </a>
                    ...
                    <span className="btn m-0 p-0 me-5">
                      <a
                        size={16}
                        href={"mailto:" + personDetails?.email_id}
                        className="text-dark"
                      >
                        <SiGmail />{" "}
                      </a>
                    ...
                    <div className="d-flex justify-content-between">
                      <div>
                        <div
                          ...
                          align=""
                          style={{ fontSize: fieldProps?.fsNormal }}
                        >
                          Primary
                        </div>
                        <ul className=" ">
                          {mySkills
                            ?.filter(
                              (item) => parseInt(item?.skill_value) >= 70,
                            )
                            ?.map((item, index) => (
                              <li
                                type="circle"
                                ...
                                style={{ fontSize: fieldProps?.fsNormal }}
                              >
                                <div align="justify">{item?.skill_name}</div>
                              </li>
                            ))}
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul className=" ">
                          {mySkills
                            ?.filter((item) => parseInt(item?.skill_value) < 70)
                            ?.map((item, index) => (
                              <li
                                type="circle"
                                className=""
                  ...
                  <div className="mt-0">
                    ...
                    >
                      <li type="circle" key={0}>
                        B.Tech - Computer Science - RGUKT
                      </li>
                      <li type="circle" key={1}>
                        PUC (Inter) - MPC - RGUKT
                      </li>
                      <li type="circle" key={3}>
                        SSC - ZPP High School
                      </li>
                    </ul>
                  </div>
                ...
                <div className="blckDiv4" style={{ border: "" }}></div>
                <div className="blckDiv5" style={{ border: "" }}></div>
                <div className="blckDiv6" style={{ border: "" }}></div>
              </td>
              <td
                width={"60%"}
                className="p-3 m-0 "
              ...
              >
                <div className="mt-0" style={{ zIndex: "10" }}>
                  ...
                  <p
                    className="m-0 p-0"
                    align="justify"
                    style={{ fontSize: fieldProps?.fsSmall }}
                  >
                    {portfolioDetails?.summaryEducation?.map(
                      (sumItem, sumIndex) => {
