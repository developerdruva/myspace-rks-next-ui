...
const CoverPage = () => {
  ...
  return (
    <div style={{ backgroundColor: themeMode ? "white" : "black" }}>
      <NavbarHeader
        logoTitle={"MYSPACEBLOG"}
        navbarItems={navItemsCoverPage}
      ...
      <Container>
        <div className="vh-100">
          <div className="d-block justify-content-center ">
            <h1
              className="m-5 mb-0 p-5 pb-0 text-uppercase title "
              style={{ color: themeMode ? "black" : "lightblue" }}
            >
              Welcome to myspace blog
            </h1>
            <div className="titleDesc p-4">
              Rajesh, is a full-stack developer. He blogs mostly on modern
              Javascript, HTML, CSS, and everything web development-related. In
              recent years he has gained experience in single-page applications.
            </div>
          </div>
          <div className="m-0 ">
